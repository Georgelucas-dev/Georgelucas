    ...
    <section className="min-h-screen bg-zinc-100 text-black flex items-center">
      <div className="w-full border-b-2 border-zinc-300">
        <div className="grid grid-cols-[1fr_2fr_1fr_44px]">
          ...
          <div className="col-span-1 border-r-2 px-10 pt-10 pb-8 border-b-2 border-zinc-300">
          </div>
          ...
          <div className="px-10 py-8 border-r-2 border-zinc-300">
            <p className="text-xl text-zinc-500 leading-relaxed max-w-65">
              Oi! Sou estudante de desenvolvimento em Santa Catarina. Todo dia
              aprendo, quebro e conserto alguma coisa — e gosto assim.
            </p>
          </div>
          ...
          <div className="px-10 py-8 border-r-2  border-zinc-300">
            ...
            <div className="flex items-center gap-2">
              <span className="text-xl">Ou falar comigo</span>
            </div>
          </div>
